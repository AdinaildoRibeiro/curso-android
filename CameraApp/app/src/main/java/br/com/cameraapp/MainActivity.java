...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSavePhoto.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (bitmap == null){
                    Toast.makeText(MainActivity.this, "Tire uma foto primeiro", Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    public void save(String name){
        ...
        String root = Environment.getExternalStorageDirectory().getAbsolutePath(); //pega o caminho interno
        ...
        try {
            ...
            b.setTitle("Mensagem");
            b.setMessage("Arquivo salvo no celular no caminho " + file.getAbsolutePath());
